...
const categorySlugs = Object.keys(recubrimientoProducts);
  ...
  <PageLayout>
    ...
    <section className="py-20 bg-background">
      <div className="container">
        <p className="section-label">Nuestras Categorías</p>
            ...
            return (
              <motion.div key={slug} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}>
                ...
                >
                  ...
                  <h3 className="font-display text-xl font-bold text-foreground mb-2">{p.productName}</h3>
