            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${contactInfo.phone.replace(/\s/g, "")}`} className="text-sm text-card/80 font-body hover:text-secondary transition-colors">{contactInfo.phone}</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded bg-secondary/20 flex items-center justify-center">
                ...
                <div>
                  ...
                  <a href={`mailto:${contactInfo.email}`} className="text-sm text-card/80 font-body hover:text-secondary transition-colors">{contactInfo.email}</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded bg-secondary/20 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-card/80 font-body">{contactInfo.address}</p>
                </div>
              </div>
            </div>
          </motion.div>
